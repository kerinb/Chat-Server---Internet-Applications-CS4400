...
java -cp cs4400chatserver main.java.ChatServer $1

## (2) This is for launching with debug port open (23456) - will not allow connections until debugger connects
#java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=23456 -cp cs4400chatserver main.java.ChatServer $1
